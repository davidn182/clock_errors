<img alt="OBS clock errors: A Python Toolbox for correcting clock errors of OBSs." class="right" style="width: 40%" src="https://github.com/davidn182/OBS_clock_errors/blob/main/clock_errors_py/Figures/timing_logo.pdf" />
